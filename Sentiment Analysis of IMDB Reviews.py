...
df_train = df[["review", "sentiment"]][df.type.isin(['train'])].reset_index(drop=True)
df_test = df[["review", "sentiment"]][df.type.isin(['test'])].reset_index(drop=True)
...
df_freq = pd.concat([X_train, X_test], ignore_index = True)
